...
export class JavaClassLoader {
  ...
  _loadClassesImpl(classpath, loadClassMembers, fullRefresh) {
    ...
    console.log('autocomplete-java loading project classes. loadMembers: ' +
      loadClassMembers);
    return classReader.readClassesFromClasspath(classpath, !fullRefresh,
    (cp, className, classMembers) => {
      ...
      return fullRefresh ? this._loadSystemLibs(classReader) :
        Promise.resolve();
    });
  }

  _loadSystemLibs(classReader) {
